...
<nav class="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
    <div class="grid grid-cols-6 h-14">
        ...
        <a
            ...
            class="flex flex-col items-center justify-center gap-0.5 {{ $isActive ? 'text-primary' : 'text-gray-500 dark:text-gray-400' }} hover:text-primary transition-colors relative">
            @if ($item['icon'] === 'home')
