@props(['icon' => '', 'title' => '', 'value' => 0, 'trend' => 'up', 'trendValue' => '0%'])

<div class="bg-white dark:bg-gray-800 rounded-lg shadow-premium hover:shadow-premium-lg transition-shadow p-6 border border-gray-200 dark:border-gray-700">
